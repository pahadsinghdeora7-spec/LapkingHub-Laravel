...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('view-inventory', fn (User $user): bool => $user->hasAnyPermission(['view-inventory','manage-inventory']));
        Gate::define('adjust-stock', fn (User $user): bool => $user->hasPermission('adjust-stock'));
        Gate::define('view-stock-history', fn (User $user): bool => $user->hasAnyPermission(['view-stock-history','manage-inventory']));
