...
return [
    ...
    'mailers' => [
        ...
        'failover' => ['transport' => 'failover', 'mailers' => explode(',', env('MAIL_FAILOVER_MAILERS', 'smtp,log'))],
        'roundrobin' => ['transport' => 'roundrobin', 'mailers' => explode(',', env('MAIL_ROUNDROBIN_MAILERS', 'ses,postmark'))],
    ],
